...
DEFAULT_INPUT = PROJECT_ROOT / "images" / "navigation" / "001-011.png"
...
def render_frame(source: Image.Image, index: int, total_frames: int) -> Image.Image:
    """Render one undistorted 9:16 frame for the intent-aware menu pause."""
    ...
    # Use subpixel crop coordinates to avoid integer-step jitter.
    x = VIEWPORT_X_START + (VIEWPORT_X_END - VIEWPORT_X_START) * eased
    y = (scaled_height - OUTPUT_HEIGHT) * VIEWPORT_Y_FOCUS
